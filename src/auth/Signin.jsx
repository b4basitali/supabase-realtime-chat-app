  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      try {
        ...
        setError("Something went wrong while signing in. Try again later!");
        setTimeout(() => setSuccessMsg(null), 5000);
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex w-[60vw] lg:w-[30vw] flex-col gap-5 items-center justify-center bg-slate-100 shadow-lg p-5 rounded-lg">
        ...
        <button
          type="submit"
          className="w-full mt-3 bg-blue-600 rounded-md h-8 text-white flex justify-center items-center gap-2"
          disabled={isLoading}
        >
          {isLoading && (
            <svg
